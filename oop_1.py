...
Атрибуты:
    ...
    дней на выполнение
    created - c точной датой и временем созданияabout:blank#blocked
Методы:
...
class Homework:
    ...
    def is_active(self):
        if Homework.__init__.created > Homework.__init__.deadline: 
            return False
        else: 
            return True
...
class Student:
    ...
    def do_homework(homework):
        if  Homework.is_active == True:
            ...
            print("You are late lol")
            return None
    
class Teacher:

    def create_homework(self, task_text, task_days):
